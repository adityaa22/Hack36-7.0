...
export default function Landing() {
    ...
    return (
        <section id="Landing" data-aos="fade-up">
            <main className="pt-4">
                <div className="h-[90vh] bg-cover relative mx-5 rounded-lg  bg-[url('/landing.png')] bg-center bg-no-repeat">
                    <div className="grid h-full grid-cols-1 grid-rows-1 lg:grid-cols-2 ">
                        <div className="flex flex-col items-center justify-center h-full row-span-1 px-4 py-16 space-y-4 text-center outline-2 ">
                            <Image
                                src={CCLOGO}
                                alt="computer coding club logo"
                                className="mx-auto w-[350px] 2xl:w-[450px] h-auto"
                            />
              ...
              >
                <img src="/google-forms.png" className="inline-block" />
                <span className="text-xs font-bold uppercase w-max">
                  Fill Team Details
