...
import MnnitMap from "../components/MnnitMap";
    ...
    <>
      ...
      >
        ...
        <main className="container mt-4">
          <div className=" bg-[url('/landing.png')] h-[550px] bg-cover relative mx-5 rounded-lg shadow-lg bg-right-bottom">
            <div className="grid grid-cols-2">
              <div className="px-4 py-16 space-y-4 text-center outline-2">
                ...
                <a>
                  <p className="inline-block rounded p-1 space-x-1 bg-[#5865F2]">
                    <svg
