        ...
        <div className="  max-h-[700px] h-screen bg-cover relative mx-5 rounded-lg  bg-[url('/landing.png')] bg-center bg-no-repeat">
          <div className="grid grid-cols-1 lg:grid-cols-2 ">
            <div className="px-4 py-16 space-y-4 text-center outline-2 ">
              ...
              <a
                className="flex mx-auto justify-center items-center rounded w-full max-w-[312px] h-[44px] p-2 space-x-2 bg-gray-900 text-white"
              ...
              >
                ...
                <svg
                  ...
                  className="inline bi bi-discord"
                  viewBox="0 0 16 16"
                ><path  strokeLinecap="round" strokeLinejoin="round" strokeWidth="12" d="M68 89h56m-56 24h56m-56 24h36"/><path   d="M52 28a2 2 0 0 0-2 2v132a2 2 0 0 0 2 2h88a2 2 0 0 0 2-2V62h-28a6 6 0 0 1-6-6V28H52Zm68 8.485L133.515 50H120V36.485ZM38 30c0-7.732 6.268-14 14-14h62c1.591 0 3.117.632 4.243 1.757l34 34A6 6 0 0 1 154 56v106c0 7.732-6.268 14-14 14H52c-7.732 0-14-6.268-14-14V30Z" clipRule="evenodd"/></svg>
                <span className="text-xs font-bold uppercase">
                  Fill Team Details<span className="ml-2 text-xs text-red-700">(mandatory)</span>
                </span>
              </a>
              <a
